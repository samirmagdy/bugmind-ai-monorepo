...
- The system now uses Render's managed Postgres. The Blueprint pins the backend and database to the same Render region so Render's internal database hostname resolves correctly.
