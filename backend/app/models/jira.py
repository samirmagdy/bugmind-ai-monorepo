...
class JiraConnection(Base):
    ...
    xray_cloud_client_id: Mapped[str] = mapped_column(String, nullable=True)
    encrypted_xray_cloud_client_secret: Mapped[str] = mapped_column(String, nullable=True)
...
class JiraFieldMapping(Base):
    ...
    id: Mapped[int] = mapped_column(primary_key=True, index=True)
    user_id: Mapped[int] = mapped_column(ForeignKey("users.id"))
    jira_connection_id: Mapped[int] = mapped_column(ForeignKey("jira_connections.id", ondelete="CASCADE"), nullable=True, index=True)
    workspace_id: Mapped[int] = mapped_column(ForeignKey("workspaces.id", ondelete="CASCADE"), nullable=True, index=True)
...
class JiraSyncHistory(Base):
    ...
    project_id: Mapped[str] = mapped_column(String, nullable=True)
    project_key: Mapped[str] = mapped_column(String, nullable=True)
