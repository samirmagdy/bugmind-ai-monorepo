...
class User(Base):
    ...
    google_subject: Mapped[str] = mapped_column(String, unique=True, index=True, nullable=True)
    ...
    # AI Settings
    custom_ai_model: Mapped[str] = mapped_column(String, nullable=True)
    encrypted_ai_api_key: Mapped[str] = mapped_column(String, nullable=True)
